...
FORCEINLINE ivec2 ivec2_new(i32 x, i32 y) 
{
    return (ivec2) { x, y };
}
...
FORCEINLINE ivec2 ivec2_negated(ivec2 vector)
{
    return (ivec2) {-vector.x, -vector.y};
}
...
FORCEINLINE ivec3 ivec3_new(i32 x, i32 y, i32 z)
{
    return (ivec3) { x, y, z };
}
...
FORCEINLINE ivec3 ivec3_negated(ivec3 vector)
{
    return (ivec3) {-vector.x, -vector.y, -vector.z};
}
...
FORCEINLINE ivec4 ivec4_new(i32 x, i32 y, i32 z, i32 w)
{
...
FORCEINLINE void quaternion_orientation(quaternion q,
    vec3* forward, vec3* right, vec3* up)
{
