...
f32 GDF_FRandom() { return (float)GDF_Random() / (f32)RAND_MAX; }
...
ivec3 ivec3_adjacent_offsets[6] = { (ivec3){ .x = 0, .y = 0, .z = 1 },
    (ivec3){ .x = 0, .y = 0, .z = -1 }, (ivec3){ .x = 0, .y = 1, .z = 0 },
    (ivec3){ .x = 0, .y = -1, .z = 0 }, (ivec3){ .x = 1, .y = 0, .z = 0 },
    (ivec3){ .x = -1, .y = 0, .z = 0 } };
