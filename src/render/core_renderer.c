...
bool create_grid_pipeline(VkRenderContext* vk_ctx, CoreRendererContext* ctx);
bool create_ui_pipeline(VkRenderContext* vk_ctx, CoreRendererContext* ctx);
...
bool create_grid_pipeline(VkRenderContext* vk_ctx, CoreRendererContext* ctx)
{
    ...
    vk_ctx->grid_pipeline.vert = vk_ctx->builtin_shaders[GDF_VK_SHADER_MODULE_INDEX_GRID_VERT];
    vk_ctx->grid_pipeline.frag = vk_ctx->builtin_shaders[GDF_VK_SHADER_MODULE_INDEX_GRID_FRAG];

    VkPipelineShaderStageCreateInfo grid_shaders[] = {
        {
            .sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO,
            .stage = VK_SHADER_STAGE_VERTEX_BIT,
            .module = vk_ctx->grid_pipeline.vert,
            .pName = "main"
        },
        {
            .sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO,
            .stage = VK_SHADER_STAGE_FRAGMENT_BIT,
            .module = vk_ctx->grid_pipeline.frag,
            .pName = "main"
        }
    };
    ...
    VkGraphicsPipelineCreateInfo pipeline_create_info = {
        ...
        .layout = vk_ctx->grid_pipeline.layout,
...
bool create_ui_pipeline(VkRenderContext* vk_ctx, CoreRendererContext* ctx)
{
    pipeline_ui* pipeline = &vk_ctx->ui_pipeline;
    ...
    pipeline->vert = vk_ctx->builtin_shaders[GDF_VK_SHADER_MODULE_INDEX_UI_VERT];
    pipeline->frag = vk_ctx->builtin_shaders[GDF_VK_SHADER_MODULE_INDEX_UI_FRAG];
